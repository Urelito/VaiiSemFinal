     ...
     <div class="container-fluid">
         ...
         <div id="responsive-navbar" class="collapse navbar-collapse justify-content-center">
             <ul class="navbar-nav">
                 ...
                 <li><a class="nav-link px-4 fw-bolder" href="../SemMVC/App/Views/forum.php">Fóra</a></li>
                 <li><a class="nav-link px-4 fw-bolder" href="../SemMVC/App/Views/novinky.php">Novinky</a></li>
                  <?php
                  $helper = "../SemMVC/App/Models/session_manager.php";
                    if (isset($_SESSION['id'])) {
                        echo "<li><a class=\"nav-link px-4 fw-bolder\" onclick=\"userLogout($helper)\"  href=\"#\">Odhlásiť</a></li>";
                    } else {
                        echo "<li><a class=\"nav-link px-4 fw-bolder\" href=\"../SemMVC/App/Views/prihlasenie.php\">Prihlásenie</a></li>";
                    }
                  ?>

                 <li><a class="nav-link px-4 fw-bolder" href="../SemMVC/App/Views/registracia.php">Registrácia</a></li>
             </ul>
         </div>
     </div>
 </nav>
     ...
     <div class="container px-4 px-lg-5">
         <div class="row gx-4 gx-lg-5 h-100 justify-content-center">
             ...
             <div class="col-lg-8 align-self-baseline" style="padding-top: 70px;">
                 ...
                 <div class="btn-align">
                     <a class="btn-align btn btn-secondary" href="../SemMVC/App/Views/forum.php">Vytvorené fóra</a>
                     <a class="btn-align btn btn-secondary" href="../SemMVC/App/Views/prihlasenie.php">Prihlásenie</a>
                 </div>
             </div>
         </div>
     </div>
